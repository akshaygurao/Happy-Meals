	...
	<nav id="mainNav" class="navbar navbar-default navbar-fixed-top">
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse"
				...
				<li><a href="${contextPath}/user/settings.htm">Account Settings</a></li>
		...
		<div class="header-content">
			<div class="header-content-inner">
				...
				<form class="navbar-form" role="search" method="post"
					action="${contextPath}/rest/search.htm">
					<div class="input-group add-on">
						<input class="form-control" placeholder="Search" name="keyword"
							id="srch-term" type="text" required> <br />
						<br />
						<input type="submit" class="btn btn-primary btn-xl page-scroll"
							value="Search"><br /> <br />
					</div>
				</form>
