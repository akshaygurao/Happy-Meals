		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav navbar-right">
					<li><a href="${contextPath}/logout.htm">Back</a></li>
				</ul>
			</div>
			<!-- /.navbar-collapse -->
		</div>
	...
	<header>
		<div class="header-content">
			<div class="header-content-inner">
				<h1 id="homeHeading">Register and start promoting!</h1>
				<hr>

				<form:form class="navbar-form" id="registration-form"
					action="${contextPath}/user/register-owners" commandName="user"
					method="post">
					<div class="input-group add-on">
						<table>
							<tr>
								<td>First Name:</td>
								<td><form:input class="form-control" path="firstName" id="firstName"
										required="required" placeholder="First Name" htmlEscape="true" />
									<font color="red"><form:errors path="firstName" /></font></td>
							</tr>

							<tr>
								<td>Last Name:</td>
								<td><form:input class="form-control" path="lastName" id="lastName"
										required="required" placeholder="Last Name" htmlEscape="true" />
							...
							<tr>
								...
								<td><form:input class="form-control" path="username" id="username"
										required="required" placeholder="UserName" htmlEscape="true" />
									<font color="red"><form:errors path="username" /></font></td>
							</tr>

							<tr>
								<td>Password:</td>
								<td><form:password class="form-control" path="password" id="password"
										required="required" placeholder="Password" htmlEscape="true" />
							...
							<tr>
								<td>Email Id:</td>
								<td><form:input class="form-control" id="email"
										path="email.emailAddress" type="email" required="required"
										placeholder="Email Id" htmlEscape="true" /> <font color="red"><form:errors
											path="email.emailAddress" /></font></td>
							</tr>

						</table>
						<br /> <input type="submit" value="Register Owner"
							class="btn btn-primary btn-xl page-scroll" /> <br />
					</div>
				</form:form>
			</div>
		</div>
