	...
	<header>
		<div class="header-content">
			<div class="header-content-inner">
				<h1 id="homeHeading">Welcome to your homepage, Admin.</h1>
				<hr>
				<a href="${contextPath}/user/viewUsers.htm" class="btn btn-primary btn-xl page-scroll">View all Registered Users</a>
				<a href="${contextPath}/user/viewRestaurants.htm" class="btn btn-primary btn-xl page-scroll">View all Registered Restaurants</a>
				<br/>
				<h2>Check your Messages here:</h2>
				<br /> <a href="${contextPath}/message/compose.htm"
					class="btn btn-primary btn-xl page-scroll">Compose</a> <a
					href="${contextPath}/message/inbox.htm"
					class="btn btn-primary btn-xl page-scroll">Inbox</a> <a
					href="${contextPath}/message/sentMail.htm"
					class="btn btn-primary btn-xl page-scroll">Sent Mail</a>
			</div>
		</div>
	</header>
