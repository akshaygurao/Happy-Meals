	...
	<header>
		<div class="header-content">
			<div class="header-content-inner">
				<h1 id="homeHeading">Welcome to your homepage,
					${user.firstName}</h1>
				<hr>
				<h2>Register Restaurants</h2>
				<br /> <a href="${contextPath}/rest/registerRestaurant.htm"
					class="btn btn-primary btn-xl page-scroll">Register</a>
				<a href="${contextPath}/rest/viewRegistered.htm"
					class="btn btn-primary btn-xl page-scroll">View Registered</a><br />
				<br />
