	...
	<header>
		<div class="header-content">
			<div class="header-content-inner">
				<h1 id="homeHeading">Change your account settings</h1>
				<hr>

				<form:form class="navbar-form" id="registration-form"
					action="${contextPath}/user/settings" commandName="user"
					method="post">
						...
						<table>
							<tr>
								...
								<td><form:input class="form-control" path="firstName" id="firstName"
										required="required" value="${u.firstName}" htmlEscape="true" />
							...
							<tr>
								...
								<td><form:input class="form-control" path="lastName" id="lastName"
										required="required" value="${u.lastName}" htmlEscape="true" />
							...
							<tr>
								...
								<td><form:input class="form-control" path="username" id="username"
										required="required" value="${u.username}" htmlEscape="true" />
							...
							<tr>
								...
								<td><form:password class="form-control" path="password" id="password"
										required="required" value="${u.password}" htmlEscape="true" />
