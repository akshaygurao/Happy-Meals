	...
	<header>
		<div class="header-content">
			<div class="header-content-inner">
				<h1 id="homeHeading">View all Restaurants</h1>
				<hr>
						...
						<tbody>
							<c:forEach items="${restaurantList}" var="restaurant">
								<tr>
									<td><h3>
											<a
												href="${contextPath}/rest/profile.htm?restaurantName=${restaurant.restaurantName}">${restaurant.restaurantName}</a>
										</h3></td>
									<td><h3>${restaurant.restaurantLocation}</h3></td>
									<td><h3>${restaurant.registrar}</h3></td>
									<td><h3>${restaurant.restaurantPhone}</h3></td>
									<td><h3><a href="${contextPath}/rest/deleteRestaurant.htm?restaurantName=${restaurant.restaurantName}">Delete</a></h3>
								</tr>
							</c:forEach>
						</tbody>
					</table>
