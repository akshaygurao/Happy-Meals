	...
	<header>
		<div class="header-content">
			<div class="header-content-inner">
				<h1 id="homeHeading">Restaurant Search Results Page</h1>
				<hr>
				<h3>You searched for: ${searchQuery}</h3>
				<div class="input-group add-on">
					<table class="table">
						<thead>
							<tr>
								<td><h3><b>Restaurant Title</b></h3></td>
								<td><h3><b>Restaurant Location</b></h3></td>
							</tr>
						</thead>
						<tbody>
							<c:forEach items="${restaurantList}" var="restaurant">
								<tr>
									<td><h3><a
										href="/myapp/rest/profile.htm?restaurantName=${restaurant.restaurantName}">${restaurant.restaurantName}</a></h3></td>
