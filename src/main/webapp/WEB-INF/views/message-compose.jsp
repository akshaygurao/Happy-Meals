	...
	<header>
		<div class="header-content">
			<div class="header-content-inner">
				<h1 id="homeHeading">Compose new messages here,
					${user.firstName}</h1>
				<hr>
				<form class="navbar-form" method="post"
					action="${contextPath}/message/reply.htm">
					<div class="input-group add-on">
						<h2> From : <c:out value='${user.firstName}' /></h2>						
						<h2>To :</h2><input type="text" name="to" class="form-control"
							placeholder="Receiver username" required><br/>
						<h2>Message :</h2>
						<textarea name='message' rows='6' cols="25" required class="form-control"></textarea>
